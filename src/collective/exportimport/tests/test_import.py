...
class TestImport(unittest.TestCase):
    ...
    def test_import_localroles(self):
        ...
        api.user.grant_roles(username="jane", obj=portal, roles=["Reviewer", "Owner"])
        transaction.commit()
        ...
        api.user.revoke_roles(username="jane", obj=portal, roles=["Reviewer", "Owner"])
        ...
        self.assertEqual(
            portal.__ac_local_roles__,
            {"admin": ["Owner"], "jane": ["Owner", "Reviewer"]},
        )
